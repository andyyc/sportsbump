...
@implementation SCDjangoAuthClient
...
- (void)connection:(NSURLConnection *)connection didReceiveResponse:(NSURLResponse *)response {
  SCDjangoAuthLoginResult *resultObject = [SCDjangoAuthLoginResult loginResultFromResponse:response];
